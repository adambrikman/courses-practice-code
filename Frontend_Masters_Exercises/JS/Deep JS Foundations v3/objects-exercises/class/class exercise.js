...
class Workshop extends Helpers {
  ...
  constructor() {
    /* Note: If you have a child constructor (in our case, we have Helpers),
    you must call super() as the first line of your constructor in order to
    have a 'this' context within Workshop
    */
    super();
