...
function isPalindrome(str) {
  ...
  /*
    If the first character is the same as the last, create a substring
    trimming off the first and last characters. Recursively call this
    until str.length < 2. Else, it is not a palindrome.
  */
  if(first === last) {
